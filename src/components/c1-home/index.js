			...
			<Container className={styles.container}>
				<div className={styles.content}>
					<div className={styles.info}>
						...
						<p className={styles.text}>I’m a Front-End Developer located in Belarus. I have a serious passion for by the development.</p>
						<p className={styles.text}>
							Well-organized person, problem solver, independent employee with high attention to detail. Fan of sports, TV series or films by Marvel.{' '}
						</p>
						<p className={styles.text}>
							{' '}
							I have experience in creating SPA
							<br /> using:
							<span id={'runText'} className={styles.runText}></span>
						</p>
						<div className={styles.linkBox}>
							<NavLink className={styles.linkInfo} to={'/portfolio'}>
								View portfolio
							</NavLink>
							<a className={styles.linkInfo} target={'_blank'} href={'#'}>
								Download resume
							</a>
						</div>
					</div>
					...
					<div className={styles.avatar}>
						<div className={styles.box_img}>
							<img src={profile} alt='myself' className={'img'} style={{ transform: `translate(${move})` }} />
						</div>
					</div>
				</div>
			</Container>
